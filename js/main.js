...
$(window).load(function(){ 
 ...
 $("#testimonial-carousel").owlCarousel({
  ...
  $("#blog-itens-container").owlCarousel({
    ...
    $("#blog-itens-container1").owlCarousel({
    navigation : false, // Show next and prev buttons
    slideSpeed : 300,
    paginationSpeed : 400,      
    responsiveRefreshRate : 200,
  ...
  items : 3,
     ...
     $("#blog-itens-container2").owlCarousel({
    navigation : false, // Show next and prev buttons
    slideSpeed : 300,
    paginationSpeed : 400,      
    responsiveRefreshRate : 200,
  ...
  items : 3,
      ...
      $("#blog-itens-container3").owlCarousel({
    navigation : false, // Show next and prev buttons
    slideSpeed : 300,
    paginationSpeed : 400,      
    responsiveRefreshRate : 200,
...
$(document).ready(function(){
  ...
  $("#countdown").countdown("2016/09/24,09:00 AM", function(event) {
